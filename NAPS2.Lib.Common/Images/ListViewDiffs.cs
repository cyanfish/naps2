...
public record ListViewDiffs<T>
{
    ...
    public ImmutableList<AppendOperation> AppendOperations { get; init; }

    public ImmutableList<ReplaceOperation> ReplaceOperations { get; init; }

    public ImmutableList<TrimOperation> TrimOperations { get; init; }
