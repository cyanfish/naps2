...
namespace NAPS2.Lang.Resources {
    ...
    internal class UiStrings {
        ...
        /// </summary>
        internal static string ResolutionScale {
            get {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Preserves aspect ratio. 100% by default, can be reduced down to 10%.
        /// </summary>
        internal static string ResolutionScaleHelp {
            get {
                return ResourceManager.GetString("ResolutionScaleHelp", resourceCulture);
            }
        }
