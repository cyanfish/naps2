...
public abstract class EtoPlatform
{
    ...
    public virtual float GetScaleFactor(Screen screen) => screen.RealScale;
    ...
    public float GetLayoutScaleFactor(Screen screen) => ScaleLayout ? GetScaleFactor(screen) : 1f;
