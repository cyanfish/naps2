...
{
    public interface IExtendedScanSettings
    {
        ScanScale AfterScanScale { get; }
        int Brightness { get; }
        int Contrast { get; }
        ScanBitDepth BitDepth { get; }
        bool MaxQuality { get; }
        int IconID { get; }
        ScanHorizontalAlign PageAlign { get; }
        ScanPageSize PageSize { get; }
        ScanDPI Resolution { get; }
