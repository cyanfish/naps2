...
namespace NAPS2.ImportExport.Pdf
{
    public class GhostscriptManager
    {
        ...
        private ExternalComponent GhostscriptComponent32 =>
            new ExternalComponent("generic-import", Path.Combine(componentManager.BasePath, "gs-9.21", "gsdll32.dll"), PlatformSupport.Windows,
        ...
        private ExternalComponent GhostscriptComponent64 =>
            new ExternalComponent("generic-import", Path.Combine(componentManager.BasePath, "gs-9.21", "gsdll64.dll"), PlatformSupport.Windows,
