...
public static class MacPackager
{
    public static void Package(PackageInfo packageInfo)
    {
        ...
        {
            Cli.Run("dotnet", $"publish NAPS2.App.Mac -c InstallerEXE");
            sourcePath = Path.Combine(Paths.SolutionRoot, "NAPS2.App.Mac", "bin", "InstallerEXE", "net7-macos10.15",
                "publish", "NAPS2-1.0.pkg");
        }
        else
        {
