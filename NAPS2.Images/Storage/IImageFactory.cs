...
public interface IImageFactory
{
    ...
    /// <returns></returns>
    IMemoryImage Decode(Stream stream, string ext);
    ...
    /// <returns></returns>
    IMemoryImage Decode(string path);
    ...
    /// <returns></returns>
    IEnumerable<IMemoryImage> DecodeMultiple(Stream stream, string ext, out int count);
    ...
    /// <param name="count">The number of returned images.</param>
    /// <returns></returns>
    IEnumerable<IMemoryImage> DecodeMultiple(string path, out int count);

    IMemoryImage FromDimensions(int width, int height, ImagePixelFormat pixelFormat);
}